  ...
  if(!message.guild || message.author.bot) return
	if (message.content === `site`) {
	  return message.channel.send(new Discord.MessageEmbed()
                                ...
                                .setDescription("Websitemiz için **[buraya](https://web.blackcodetr.cf/)** tıkla!"));
	}
  });
...
client.user.setPresence({ activity: { type: 'STREAMING', name: '#AlwaysBlack' }, status: "dnd" });
})
...
map += `${a.codeName} **->** [Click Here](https://web.blackcodetr.cf/code/${a.code})\n`
})
}
